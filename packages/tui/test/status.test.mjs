...
test("indicatorFor maps statuses to visible levels", () => {
  ...
  assert.equal(indicatorFor({ status: "unsupported-version", version: "2.0.0" }).level, "warn")
  assert.equal(indicatorFor({ status: "portable", version: "2.0.0" }).level, "warn")
  ...
  assert.match(indicatorFor({ status: "portable", version: "9.9.9" }).detail, /lacks verified rich-renderer host capability/)
