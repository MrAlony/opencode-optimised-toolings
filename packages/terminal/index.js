...
function detectFilesystemSubstitution(command) {
  const patterns = [
    { regex: /\b(Get-Content|gc|cat|type)\b/i, kind: "source/file reading", replacement: "alonix-read with `paths` or exact `requests[].ranges`" },
